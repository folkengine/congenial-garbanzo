...
public class NaiveBayesTest {
    ...
    public BufferedReader getTestDataReader(String path) throws FileNotFoundException {
    ...
    public NaiveBayesTest() {
        ...
        try(BufferedReader input = getTestDataReader("src/test/resources/data/text/movie.txt")) {
    ...
    public void testPredict() {
        ...
        try {
            AttributeDataset iris = arffParser.parse(new java.io.File("src/test/resources/data/weka/iris.arff"));
